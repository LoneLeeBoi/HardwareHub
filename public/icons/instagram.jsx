    ...
    <>
      <svg viewBox="0 0 1000 1000" className={props.className}>
        <g>
          ...
          >
            <stop offset="0" stopColor="#ffd521"></stop>
            <stop offset=".055" stopColor="#ffd020"></stop>
            <stop offset=".124" stopColor="#fec01e"></stop>
            <stop offset=".2" stopColor="#fca71b"></stop>
            <stop offset=".282" stopColor="#fa8316"></stop>
            <stop offset=".368" stopColor="#f85510"></stop>
            <stop offset=".456" stopColor="#f51e09"></stop>
            <stop offset=".5" stopColor="#f30005"></stop>
            <stop offset=".503" stopColor="#f20007"></stop>
            <stop offset=".597" stopColor="#e1003b"></stop>
            <stop offset=".688" stopColor="#d30067"></stop>
            <stop offset=".776" stopColor="#c70088"></stop>
            <stop offset=".859" stopColor="#bf00a0"></stop>
            <stop offset=".936" stopColor="#bb00af"></stop>
