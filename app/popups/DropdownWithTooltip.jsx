  ...
  return (
    <div className="relative inline-block group" ref={ref}>
      ...
      <div
        ...
        className="cursor-pointer hover:bg-gray-200 rounded-full text-sm relative"
      >
        {trigger}
      ...
      {/* Dropdown content */}
      {open && (
        <div className="absolute right-0 mt-2 min-w-[12rem] max-w-xs bg-white border border-gray-200 shadow-lg rounded z-50 overflow-hidden">
